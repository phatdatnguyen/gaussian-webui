...
def on_single_point_calculate(smiles_texbox: gr.Textbox, functional_textbox: gr.Textbox, basis_set_textbox: gr.Textbox,
    ...
    try:
        ...
        kwds.sp = ['SP', functional_textbox, basis_set_textbox]
        
        # Run calculation
        start = time.time()
        species.single_point(method=ade.methods.G16())
...
def single_point_calculation_tab_content():
    with gr.Tab("Single-Point Calculation") as single_point_calculation_tab:
        ...
        calculate_button.click(on_single_point_calculate, [smiles_texbox, functional_textbox, basis_set_textbox,
