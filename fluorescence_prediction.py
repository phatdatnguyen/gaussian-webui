...
def write_fluorescence_gaussian_input(mol, file_name, n_states=10, method='B3LYP', basis='6-31G(d,p)', charge=0, multiplicity=1, solvent=None, n_proc=4, memory=2):
...
def on_fluorescence_predict(mm_checkbox: gr.Checkbox, force_field_dropdown: gr.Dropdown, max_iters_slider: gr.Slider, n_state_slider: gr.Slider, solvation_checkbox: gr.Checkbox, solvent_dropdown: gr.Dropdown,
    ...
    try:
        ...
        if solvation_checkbox:
            ...
            solvent = None
        write_fluorescence_gaussian_input(mol_fluorescence, file_name=file_name_textbox, n_states=n_state_slider, method=functional_textbox, basis=basis_set_textbox, charge=charge_slider, multiplicity=multiplicity_dropdown, solvent=solvent,
    ...
    return calculation_status, fluorescence_spectrum, peak_df
...
def fluorescence_prediction_tab_content():
    with gr.Tab("Fluorescence Spectrum Prediction") as fluorescence_prediction_tab:
        ...
        predict_button.click(on_fluorescence_predict, [mm_checkbox, force_field_dropdown, max_iters_slider, n_states_slider, solvation_checkbox, solvent_dropdown,
                                                 functional_textbox, basis_set_textbox, charge_slider, multiplicity_dropdown,
                                                 n_cores_slider, memory_slider, file_name_textbox],
                                                [status_markdown, fluorescence_spectrum_plot, peak_table])
