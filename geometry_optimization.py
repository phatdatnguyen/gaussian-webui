...
def on_optimize_geometry(mm_checkbox: gr.Checkbox, force_field_dropdown: gr.Dropdown, max_iters_slider: gr.Slider, solvation_checkbox: gr.Checkbox, solvent_dropdown: gr.Dropdown,
    ...
    try:
        ...
        if solvation_checkbox:
            ...
            solvent = None
        write_opt_gaussian_input(mol_opt, file_name=file_name_textbox, method=functional_textbox, basis=basis_set_textbox, charge=charge_slider, multiplicity=multiplicity_dropdown, solvent=solvent,
